...
FFTWLIB = -L/usr/lib -lfftw3_threads -lfftw3 -lm -lpthread
...
CFLAGS = -fPIC -Wall -O3 -I./include $(FFTWINC)
...
HYDAAPLISTS = hydaap_correlate_coefficients
HYDAAPLOCS = $(patsubst %,bin/%,$(HYDAAPLISTS))
...
hydaap_correlate_coefficients: examples1/hydaap_correlate_coefficients.o libsoft1.a  
	$(CC) $(CFLAGS) examples1/hydaap_correlate_coefficients.o \
	$(LDFLAGS) ${FFTWLIB} -o bin/hydaap_correlate_coefficients
